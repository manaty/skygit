<script>
  ...
  let lastDiscoveredRepo = null;

  selectedRepo.subscribe((r) => (repo = r));

  // Automatically discover conversations when viewing a repo with messaging enabled
  $: if (repo && repo.has_messages && repo.full_name !== lastDiscoveredRepo) {
    ...
    <div class="p-6 space-y-4 bg-white shadow rounded max-w-3xl mx-auto mt-6">
      ...
      {#if repo.has_messages}
        ...
        <div class="flex border-b">
          <button
            class="px-4 py-2 text-sm font-medium {activeTab === 'details'
          ...
          <button
            class="px-4 py-2 text-sm font-medium {activeTab === 'files'
              ? 'text-blue-600 border-b-2 border-blue-600'
              : 'text-gray-500 hover:text-gray-700'}"
                  ...
                  <div class="flex items-start justify-between">
                    <div class="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div
                          class="flex items-center gap-4 text-sm text-gray-500 mt-1"
                        >
