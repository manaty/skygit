<script>
    import { GOOGLE_OAUTH_PLAYGROUND_URL } from '../services/googleDriveSetupGuideService.js';

    export let currentStep = 1;
    export let credentials = {};
    export let copiedSteps = {};
    export let authorizationUrl = '';
    export let tokenExchangeScript = '';
    export let setupComplete = false;
    export let suggestedFolderName = 'SkyGit-user';
    export let copyToClipboard = () => {};
    export let onStepChange = () => {};
    export let onCredentialsChange = () => {};
        ...
        <div class="space-y-4">
            <div>
                ...
                <input 
                    ...
                    on:input={(event) => updateCredential('client_id', event.currentTarget.value)}
            ...
            <div>
                ...
                <input 
                    ...
                    on:input={(event) => updateCredential('client_secret', event.currentTarget.value)}
    ...
    <div class="space-y-4">
        ...
        <div class="mt-6">
            ...
            <input 
                ...
                on:input={(event) => updateCredential('refresh_token', event.currentTarget.value)}
    ...
    <div class="space-y-4">
        ...
        <ol class="space-y-3">
            ...
            <li class="flex gap-3">
                ...
                <div>Create a new folder named: <code class="bg-gray-100 px-2 py-1 rounded">{suggestedFolderName}</code></div>
            </li>
            <li class="flex gap-3">
        ...
        <div class="mt-4">
            ...
            <input 
                ...
                type="text"
                value={credentials.folder_url}
                on:input={(event) => updateCredential('folder_url', event.currentTarget.value)}
